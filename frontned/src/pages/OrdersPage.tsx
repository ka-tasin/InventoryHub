...
const OrdersPage = () => {
  ...
  const updateItem = (i: number, field: string, value: any) => {
    ...
    if (field === "quantity") {
      ...
      updated[i] = { ...updated[i], quantity: value === "" ? "" : value };
    } else if (field === "productId") {
      updated[i] = { ...updated[i], productId: value };
        ...
        >
          ...
          <DialogContent className="max-w-lg">
            ...
            <DialogFooter>
              <Button
                onClick={() =>
                  createMut.mutate({ customerName, items: orderItems })
                }
                disabled={
                  !customerName || !orderItems.length || createMut.isPending
                }
              >
                {createMut.isPending ? "Creating..." : "Create Order"}
              </Button>
                                ...
                                <div>
                                  ...
                                  <div className="mt-1 space-y-1">
                                    {o.items.map((item: any, i: number) => (
                                      <div
                                        key={i}
                                        className="flex justify-between text-sm border rounded-md p-2"
                                      >
                                        <span>
